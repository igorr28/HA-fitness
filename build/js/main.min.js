...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_video_js__WEBPACK_IMPORTED_MODULE_2__["initVideos"])();
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_3__["scrollTo"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_4__["initTabs"])();
  Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_5__["initFormValidation"])();
...
// eslint-disable-next-line no-undef
var swiperCoaches = new Swiper(sliderCoaches, {
  keyboard: {
    enabled: true,
...
// eslint-disable-next-line no-undef
var swiperComments = new Swiper(sliderComments, {
  keyboard: {
    enabled: true,
    onlyInViewport: false
  },
...
var initTabs = function initTabs() {
  var tabsButtons = document.querySelectorAll('[data-ticket-btn]');
  var tabsContents = document.querySelectorAll('[data-ticket-content]');
  if (tabsButtons.length) {
    tabsButtons.forEach(function (tabsButton) {
      tabsButton.addEventListener('click', function (e) {
        var tabValue = e.target.dataset.ticketBtn;
        tabsButtons.forEach(function (elem) {
        ...
        document.querySelector("[data-ticket-content=\"".concat(tabValue, "\"]")).classList.add('is-active');
      });
    });
  }
};
...
var videos = Array.from(document.querySelectorAll('[data-video]'));
...
var initVideo = function initVideo(video) {
  ...
  if (play) {
    play.addEventListener('click', function () {
      ...
      iframe.src = "".concat(href, "?autoplay=1");
    });
  }
};
